...
class Entrant:
    ...
    def set_ovr(self, venue: Track, balance_table: BalanceTable) -> None:
        ...
        self.car_ovr = aero_perf + chassis_perf + sus_perf + engine_perf #  + self.team.tyres.performance

        self.spine_reliability = self.team.spine.reliability
        self.engine_reliability = self.team.engine.reliability
        ...
        match venue.setup_boost:
            case "Aero": self.setup_boost = self.team.aero_setup
            case "Chassis": self.setup_boost = self.team.chassis_setup
            case "Suspension": self.setup_boost = self.team.suspension_setup
